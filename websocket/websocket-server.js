...
const websocketAddressMethods = require('./websocket-address-methods');
const websocketBlockMethods = require('./websocket-block-methods');
const websocketTransactionMethods = require('./websocket-transaction-methods');
const websocketNetworkInfo = require('./websocket-network-info');
